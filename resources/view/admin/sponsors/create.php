...
<?= renderComponent(CrumbsComponent::class, ['name' => 'Create Sponsor']); ?>
    ...
    <div class="row g-5 mb-3">
        ...
        <div class="col-md-7 col-lg-8">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if ($upload_type === "file") : ?>
                            <a href="<?= URL_ROOT . "/admin/sponsors/create?ut=link" ?>" class="text-black my-2"> <i class="fa-solid fa-link"></i> Link Upload</a>
                        <?php else : ?>
                            <a href="<?= URL_ROOT . "/admin/sponsors/create?ut=file" ?>" class="text-warning my-2"> <i class="fa-solid fa-file-import"></i> File Upload</a>
                        <?php endif; ?>
                    </div>
                ...
                <button class="w-100 btn btn-dark btn-lg" type="submit">Create Sponsor</button>
            </form>
        </div>
    </div>
