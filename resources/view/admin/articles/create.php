...
<?= renderComponent(CrumbsComponent::class, ['name' => 'Create Article']); ?>
<section class="section">

    <div class="row g-5 mb-3">
        <div class="col-md-5 col-lg-4 order-md-last">
            <img src="<?= get_image($article["image"], "default"); ?>" alt="<?= $article["name"] ?? "" ?>" class="mx-auto d-block preview" style="height:250px;width:300px;object-fit:cover;border-radius: 10px;cursor: pointer;">
        </div>
        <div class="col-md-7 col-lg-8">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if ($upload_type === "file") : ?>
                            <a href="<?= URL_ROOT . "/admin/articles/create?ut=link" ?>" class="text-black my-2"> <i class="fa-solid fa-link"></i> Link Upload</a>
                        <?php else : ?>
                            <a href="<?= URL_ROOT . "/admin/articles/create?ut=file" ?>" class="text-warning my-2"> <i class="fa-solid fa-file-import"></i> File Upload</a>
                        <?php endif; ?>
                    </div>
                ...
                <button class="w-100 btn btn-dark btn-lg" type="submit">Create Article</button>
            </form>
        </div>
    </div>
