  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-8 col-lg-9">
        <h3 class="fw-bold mb-2">Create New Ticket (<?= $event['name'] ?>)</h3>
        <p class="mb-0">Fill out the form below to add new ticket</p>
      </div>
  ...
  <div class="container">
    ...
    <form action="" method="post">
      ...
      <div class="d-flex justify-content-between mt-4 mb-5">
        ...
        <div>
          <button type="submit" class="btn btn-primary-action"><i class="fas fa-check-circle ms-2"></i> Add Ticket</button>
        </div>
      </div>
    </form>
  </div>
