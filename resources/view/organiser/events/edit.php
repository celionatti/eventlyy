  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-8 col-lg-9">
        <h1 class="fw-bold mb-2">Update Event (<?= $event['name'] ?>)</h1>
        <p class="mb-0">Fill out the form below to update your event</p>
      </div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-container">
        ...
        <div class="row g-3">
          ...
          <?= BootstrapForm::inputField("Social Twitter (X)", "socials[]", old_value("socials[]", $links["twitter"] ?? ''), ['class' => 'form-control', 'type' => 'url', 'placeholder' => 'Twitter / X link'], ['class' => 'col-md-6'], $errors) ?>

          <?= BootstrapForm::inputField("Social Facebook", "socials[]", old_value("socials[]", $links["facebook"] ?? ''), ['class' => 'form-control', 'type' => 'url', 'placeholder' => 'Facebook link'], ['class' => 'col-md-6'], $errors) ?>

          <?= BootstrapForm::inputField("Social Instagram", "socials[]", old_value("socials[]", $links["instagram"] ?? ''), ['class' => 'form-control', 'type' => 'url', 'placeholder' => 'Instagram link'], ['class' => 'col-md-6'], $errors) ?>

          <?= BootstrapForm::inputField("Social Tik Tok", "socials[]", old_value("socials[]", $links["tiktok"] ?? ''), ['class' => 'form-control', 'type' => 'url', 'placeholder' => 'Tik Tok link'], ['class' => 'col-md-6'], $errors) ?>
      ...
      <div class="form-container">
        ...
        <div class="row g-3">
          <?= BootstrapForm::selectField("Highlight Event", "is_highlighted", $event["is_highlighted"] ?? '', $highlightedOpts, ['class' => 'form-select'], ['class' => 'col-md-4'], $errors) ?>

          <?= BootstrapForm::selectField("Event Status", "status", $event["status"] ?? '', $statusOpts, ['class' => 'form-select'], ['class' => 'col-md-4'], $errors) ?>

          <?= BootstrapForm::selectField("Event Ticket Sale", "ticket_sale", $event["ticket_sale"] ?? '', $saleOpts, ['class' => 'form-select'], ['class' => 'col-md-4'], $errors) ?>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between mt-4 mb-5">
        ...
        <div>
          <button type="submit" class="btn btn-primary-action">Update <i class="fas fa-arrow-right ms-2"></i></button>
        </div>
      </div>
    </form>
  </div>
