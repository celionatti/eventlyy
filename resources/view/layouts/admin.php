...
use PhpStrike\app\components\AdminHeaderComponent;
...
<head>
    ...
    <link rel="stylesheet" href="<?= asset("dist/css/natticss.css") ?>">
...
<body class="bg-body-tertiary">
    ...
    <?= renderComponent(AdminHeaderComponent::class); ?>

    <div class="container-fluid">
        <div class="row">
            <?= renderComponent(AdminSidebarComponent::class); ?>
